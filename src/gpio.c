...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, NRF_CE_Pin|HX711_DT_1_Pin|HX711_DT_2_Pin|HX711_DT_3_Pin
                          |HTU21D_1_Pin|HTU21D_2_Pin|HTU21D_3_Pin|GREEN_LED_Pin
                          |BATERY_LEVEL_CHECK_Pin, GPIO_PIN_RESET);
